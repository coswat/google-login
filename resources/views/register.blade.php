...
<div class="login-container">
  <div class="login-form">
    <div class="login-form-inner">
      ...
      <a href="{{ route('g.register') }}" class="rounded-button google-login-button">
      ...
      <div class="login-form-group">
        <label for="text">Name <span class="required-star">*</span></label>
        <input type="text" value="{{ old('name') }}" placeholder="Marry Jane" name="name">
        @error('name')
          <p class="body-text">
        {{ $message }}
        </p>
      ...
      <div class="login-form-group">
        <label for="text">Email <span class="required-star">*</span></label>
        <input type="text" value="{{ old('email') }}" placeholder="email@website.com" name="email">
                @error('email')
                  <p class="body-text">
        {{ $message }}
        </p>
      ...
      <div class="login-form-group">
        ...
        <input autocomplete="off" type="password" placeholder="Minimum 8 characters"  name="confirm_password">
      ...
      <button class="rounded-button login-cta">Register</button>
      </form>

      <div class="register-div">Not registered yet? <a href="{{ route('login') }}" class="link create-account" -link>Already have an account ?</a></div>
    </div>
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/Swiper/3.3.0/js/swiper.min.js'></script><script  src="{{ url('js/scriipt.js') }}"></script>
